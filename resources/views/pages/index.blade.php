...
@section('content')
    ...
    <section class="relative mt-20">
        <div class="container-fluid relative">
            <div class="relative py-48 table w-full shadow-md overflow-hidden">
                <div class="absolute inset-0 bg-[url('../../assets/images/shop/bg.jpg')] bg-no-repeat md:bg-left bg-center bg-cover"></div>
            ...
            <div id="grid" class="md:flex w-full justify-center mx-auto mt-4">
                <div class="md:w-1/2 p-3 picture-item">
                    <div class="group relative overflow-hidden rounded-md shadow dark:shadow-gray-800">
                        <img src="{{ asset('assets/images/shop/hoodie.jpg') }}" class="group-hover:scale-110 transition-all duration-500" alt="">
                ...
                <div class="md:w-1/2 p-3 picture-item">
                    <div class="group relative overflow-hidden rounded-md shadow dark:shadow-gray-800">
                        <img src="{{ asset('assets/images/shop/beanie.jpg') }}" class="group-hover:scale-110 transition-all duration-500" alt="">
                        <div class="absolute bottom-4 start-4">
                ...
                <div class="md:w-1/2 p-3 picture-item">
                    <div class="group relative overflow-hidden rounded-md shadow dark:shadow-gray-800">
                        <img src="{{ asset('assets/images/shop/glasses.jpg') }}" class="group-hover:scale-110 transition-all duration-500" alt="">
                        <div class="absolute bottom-4 start-4">
        ...
        <div class="container relative mt-16">
            ...
            <div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                ...
                <div class="group">
                    ...
                    <div class="mt-4">
                        <a href="shop-item-detail.html" class="hover:text-indigo-600 text-lg font-semibold">Sports Shoes</a>
                        <div class="flex justify-between items-center mt-1">
                            <p class="text-green-600">$16.00 <del class="text-red-600">$21.00</del></p>
                            <ul class="font-medium text-amber-400 list-none">
                                <li class="inline"><i class="mdi mdi-star"></i></li>
    ...
    <!-- Start -->
    <section class="py-28 w-full table relative bg-[url('{{ asset('assets/images/shop/cta.jpg') }}')] bg-center bg-no-repeat bg-cover jarallax" data-jarallax data-speed="0.5">
        ...
        <div class="container relative">
            ...
            <div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                <div class="group">
                    ...
                    <div class="mt-4">
                        <a href="shop-item-detail.html" class="hover:text-indigo-600 text-lg font-semibold">Wooden Chair</a>
                        <div class="flex justify-between items-center mt-1">
                            <p class="text-green-600">$16.00 <del class="text-red-600">$21.00</del></p>
                            <ul class="font-medium text-amber-400 list-none">
                                <li class="inline"><i class="mdi mdi-star"></i></li>
                ...
                <div class="group">
                    ...
                    <div class="mt-4">
                        <a href="shop-item-detail.html" class="hover:text-indigo-600 text-lg font-semibold">Women Block Heels</a>
                        <div class="flex justify-between items-center mt-1">
                            <p class="text-green-600">$16.00 <del class="text-red-600">$21.00</del></p>
                            <ul class="font-medium text-amber-400 list-none">
                                <li class="inline"><i class="mdi mdi-star"></i></li>
