        ...
        <div class="container relative">
            ...
            <div class="relative text-center mt-3">
                <ul class="tracking-[0.5px] mb-0 inline-block">
                    ...
                    <li class="inline uppercase text-[13px] font-bold text-indigo-600" aria-current="page">About us</li>
                </ul>
            </div>
        </div><!--end container-->
    </section><!--end section-->
        ...
        <div class="container relative md:mt-24 mt-16">
            ...
            <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-4 gap-[30px]">
                ...
                <div class="group relative lg:px-6 mt-4 transition duration-500 ease-in-out rounded-xl overflow-hidden text-center">
                    ...
                    <div class="mt-6">
                        <a href="" class="text-xl font-medium hover:text-indigo-600 duration-500 ease-in-out">Free Shipping</a>
                ...
                <div class="group relative lg:px-6 mt-4 transition duration-500 ease-in-out rounded-xl overflow-hidden text-center">
                    ...
                    <div class="mt-6">
                        <a href="" class="text-xl font-medium hover:text-indigo-600 duration-500 ease-in-out">Payment Process</a>
                        <p class="text-slate-400 transition duration-500 ease-in-out mt-3">If the distribution of letters and 'words' is random, the reader will not be distracted from making.</p>
                    </div>
                </div>
                <!-- Content -->
